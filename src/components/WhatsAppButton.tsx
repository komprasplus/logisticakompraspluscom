...
const WhatsAppButton = ({ 
  ...
  if (variant === "icon") {
    return (
      <button
        ...
        className={`flex h-10 w-10 items-center justify-center rounded-full bg-green-500 text-white hover:bg-green-600 transition-colors shadow-md ${className}`}
        title="WhatsApp"
      >
  ...
  if (variant === "inline") {
    return (
      <button
        onClick={openWhatsApp}
        className={`inline-flex items-center gap-1.5 text-green-600 hover:text-green-700 font-medium text-sm ${className}`}
      >
